...
gcloud dataproc jobs submit hive \
    --cluster=hadoop-curso-infnet \
    --region=us-central1 \
    --file=./gcp/jobs/dataproc/hive/ddl/create_database.sql

echo "Creating tables"
gcloud dataproc jobs submit hive \
    --cluster=hadoop-curso-infnet \
    --region=us-central1 \
    --file=./gcp/jobs/dataproc/hive/ddl/create_tables.sql

echo "Loading data into tables"
gcloud dataproc jobs submit hive \
    --cluster=hadoop-curso-infnet \
    --region=us-central1 \
    --file=./gcp/jobs/dataproc/hive/dml/load_data.sql
...
gcloud dataproc jobs submit hive \
    --cluster=hadoop-curso-infnet \
    --region=us-central1 \
    --file=./gcp/jobs/dataproc/hive/scripts/analytics.sql

echo "Dropping the database and tables"
gcloud dataproc jobs submit hive \
    --cluster=hadoop-curso-infnet \
    --region=us-central1 \
    --file=./gcp/jobs/dataproc/hive/ddl/drop_tables.sql
